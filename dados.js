...
// ═══════════════════════════════════════════════════════════════════════════════
// ♟️ DAMA — ENSINO FUNDAMENTAL MASCULINO (já com resultados parciais)
// 10 jogadores, chave irregular (Pietro passa direto pra Final, os demais
// seguem Primeira Fase → Quartas → Semifinal → Final)
// ═══════════════════════════════════════════════════════════════════════════════
INITIAL.mods[1].genders.fund_masc.rounds = [
  {
    id:"dm_r0", name:"Primeira Fase",
    matches:[
      {id:"dm01",p1:"Luiz H",   p2:"Vini",        winner:"Vini"},
      {id:"dm02",p1:"João P",   p2:"Jullio",      winner:"Jullio"},
      {id:"dm03",p1:"Pietro",   p2:"Ruan",        winner:"Pietro"},
      {id:"dm04",p1:"Paulo",    p2:"Leonardo A.", winner:"Paulo"},
      {id:"dm05",p1:"Hector",   p2:"João Lucas",  winner:"João Lucas"},
    ]
  },
  {
    id:"dm_r1", name:"Quartas de Final",
    matches:[
      {id:"dm06",p1:"Vini",        p2:"Jullio", winner:null},
      {id:"dm07",p1:"Pietro",      p2:"Paulo",  winner:"Pietro"},
      {id:"dm08",p1:"João Lucas",  p2:null,     winner:null},
    ]
  },
  {
    id:"dm_r2", name:"Semifinal",
    matches:[
      {id:"dm09",p1:null,     p2:"João Lucas", winner:null},
      {id:"dm10",p1:"Pietro", p2:null,         winner:null},
    ]
  },
  {
    id:"dm_r3", name:"Final",
    matches:[
      {id:"dm11",p1:"Pietro", p2:null, winner:null},
    ]
  },
];

// ═══════════════════════════════════════════════════════════════════════════════
// ♟️ DAMA — ENSINO FUNDAMENTAL FEMININO (já com resultados — campeã definida)
// 9 jogadoras, Amanda com BYE
// ═══════════════════════════════════════════════════════════════════════════════
INITIAL.mods[1].genders.fund_fem.rounds = [
  {
    id:"df_r0", name:"Primeira Fase",
    matches:[
      {id:"df01",p1:"Maria C.",      p2:"Larissa",     winner:"Larissa"},
      {id:"df02",p1:"Cecília",       p2:"Maria E.",    winner:"Maria E."},
      {id:"df03",p1:"Ana Victória",  p2:"Thifany",     winner:"Ana Victória"},
      {id:"df04",p1:"Pamela",        p2:"Ana Vitória", winner:"Pamela"},
      {id:"df05",p1:"Amanda",        p2:null,          winner:null},
    ]
  },
  {
    id:"df_r1", name:"Quartas de Final",
    matches:[
      {id:"df06",p1:"Larissa",      p2:"Maria E.", winner:"Maria E."},
      {id:"df07",p1:"Ana Victória", p2:"Amanda",   winner:"Ana Victória"},
      {id:"df08",p1:"Pamela",       p2:null,       winner:null},
    ]
  },
  {
    id:"df_r2", name:"Semifinal",
    matches:[
      {id:"df09",p1:"Ana Victória", p2:"Pamela", winner:"Ana Victória"},
      {id:"df10",p1:"Maria E.",     p2:null,     winner:null},
    ]
  },
  {
    id:"df_r3", name:"Final",
    matches:[
      {id:"df11",p1:"Maria E.", p2:"Ana Victória", winner:"Ana Victória"},
    ]
  },
];

// ═══════════════════════════════════════════════════════════════════════════════
// ♟️ DAMA — ENSINO MÉDIO MASCULINO (chave montada, sem resultados ainda)
// 6 jogadores — Erick e Guilherme com BYE
// ═══════════════════════════════════════════════════════════════════════════════
INITIAL.mods[1].genders.em_masc.rounds = [
  {
    id:"dme_r0", name:"Quartas de Final",
    matches:[
      {id:"dme01",p1:"Maikon",    p2:"João P.", winner:null},
      {id:"dme02",p1:"Erick",     p2:"BYE",     winner:"Erick"},
      {id:"dme03",p1:"Renato",    p2:"Rhian",   winner:null},
      {id:"dme04",p1:"Guilherme", p2:"BYE",     winner:"Guilherme"},
    ]
  },
  {
    id:"dme_r1", name:"Semifinal",
    matches:[
      {id:"dme05",p1:null, p2:"Erick",     winner:null},
      {id:"dme06",p1:null, p2:"Guilherme", winner:null},
    ]
  },
  {
    id:"dme_r2", name:"Final",
    matches:[
      {id:"dme07",p1:null, p2:null, winner:null},
    ]
  },
];

// ═══════════════════════════════════════════════════════════════════════════════
// ♟️ DAMA — ENSINO MÉDIO FEMININO (chave montada, sem resultados ainda)
// 9 jogadoras — Yasmim 3º x Emilly jogam; Vitorya, Isabelly e Yasmim 1º
// entram direto na coluna seguinte (Vitorya com BYE p/ alinhar as colunas)
// ═══════════════════════════════════════════════════════════════════════════════
INITIAL.mods[1].genders.em_fem.rounds = [
  {
    id:"dfe_r0", name:"Primeira Fase",
    matches:[
      {id:"dfe01",p1:"Nicolly",    p2:"Geovana",    winner:null},
      {id:"dfe02",p1:"Agatha",     p2:"Sthefany",   winner:null},
      {id:"dfe03",p1:"Yasmim 3º",  p2:"Emilly",     winner:null},
      {id:"dfe04",p1:"Vitorya",    p2:"BYE",        winner:"Vitorya"},
      {id:"dfe05",p1:"Isabelly",   p2:"BYE",        winner:"Isabelly"},
      {id:"dfe06",p1:"Yasmim 1º",  p2:"BYE",        winner:"Yasmim 1º"},
    ]
  },
  {
    id:"dfe_r1", name:"Quartas de Final",
    matches:[
      {id:"dfe07",p1:null,        p2:null,         winner:null},
      {id:"dfe08",p1:null,        p2:"Vitorya",    winner:null},
      {id:"dfe09",p1:"Isabelly",  p2:"Yasmim 1º",  winner:null},
    ]
  },
  {
    id:"dfe_r2", name:"Semifinal",
    matches:[
      {id:"dfe10",p1:null, p2:null, winner:null},
      {id:"dfe11",p1:null, p2:null, winner:null},
    ]
  },
  {
    id:"dfe_r3", name:"Final",
    matches:[
      {id:"dfe12",p1:null, p2:null, winner:null},
    ]
  },
];
